...
export const ALL_CLIENTS_DATA = 'ALL_CLIENTS_DATA';
...
export const FETCH_ACTIVATING_SUCCESS = 'FETCH_ACTIVATING_SUCCESS';
export const ACTIVATE_SINGLE_ORDER = 'ACTIVATE_SINGLE_ORDER';
export const CREATE_ORDER = 'CREATE_ORDER';
export const CREATE_ORDER_SUCCESS = 'CREATE_ORDER_SUCCESS';
export const SINGLE_ORDER_DATA = 'SINGLE_ORDER_DATA';
export const SINGLE_ORDER_TIMELINE_DATA = 'SINGLE_ORDER_TIMELINE_DATA';
